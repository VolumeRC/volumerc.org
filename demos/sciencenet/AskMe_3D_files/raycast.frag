...
const float numberOfSlices = 213.0;
const float slicesOverX = 15.0;
const float slicesOverY = 15.0;
...
void main(void)
{
	...
	float opacityFactor = 16.0;
	float lightFactor = 4.5;
